...
public class InitMongoDBDataChangeLog {
    ...
    public void initGenres(GenreClRepository repository) {
    ...
    public void initAuthors(AuthorClRepository repository) {
        log.info("Create Authors");
    ...
    public void initBooks(BookClRepository repository) {
    ...
    public void initComments(CommentClRepository repository) {
