...
class BookRepositoryTest {
    ...
    void shouldInsertBook() {
        var expectedBook = new Book(0L, "Детектив",
                new Author(1L, "Agatha Christie"), List.of(new Genre(1L, "Detective")), null);
    ...
    void shouldUpdateBook() {
        var expectedBook = new Book(1L, "Детектив",
                new Author(1L, "Agatha Christie"), List.of(new Genre(1L, "Detective")), null);
    ...
    void shouldReturnExpectedBookById() {
        var expectedBook = new Book(1L, "Murder on the Orient Express",
                new Author(1L, "Agatha Christie"), List.of(new Genre(1L, "Detective")), null);
        var actualBook = bookRepository.findById(expectedBook.getId()).orElse(null);
    ...
    void shouldReturnExpectedBooksList() {
        var expectedBookList = List.of(
                new Book(1L, "Murder on the Orient Express",
                        new Author(1L, "Agatha Christie"), List.of(new Genre(1L, "Detective")), null),
                new Book(2L, "The Three Musketeers",
                        new Author(2L, "Alexandre Dumas"), List.of(new Genre(2L, "History")), null),
                new Book(3L, "Twenty Thousand Leagues Under the Sea",
                        new Author(3L, "Jules Gabriel Verne"), List.of(new Genre(3L, "Fantasy")), null),
                new Book(4L, "The Gold Bug",
                        new Author(4L, "Edgar Allan Poe"), List.of(new Genre(3L, "Fantasy")), null),
                new Book(5L, "It",
                        new Author(5L, "Stephen Edwin King"), List.of(new Genre(4L, "Horror")), null));
