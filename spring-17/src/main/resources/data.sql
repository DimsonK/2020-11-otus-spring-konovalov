...
insert into GENRES (ID, GENRE_NAME) values (5, 'Technical');
...
insert into AUTHORS (ID, AUTHOR_NAME) values (6, 'Elizabeth McNeill');
insert into AUTHORS (ID, AUTHOR_NAME) values (7, 'E L James, Zachary Webber, et al.');
insert into AUTHORS (ID, AUTHOR_NAME) values (8, 'Попов, Шойгу и Ко');
insert into AUTHORS (ID, AUTHOR_NAME) values (9, 'Уралвагонзавод и сотоварищи');
...
insert into BOOKS (ID, AUTHOR_ID, BOOK_NAME, RARS, ACCESS_LEVEL) values (6, 6, 'Nine and a Half Weeks: A Memoir of a Love Affair', 18, 2);
insert into BOOKS (ID, AUTHOR_ID, BOOK_NAME, RARS, ACCESS_LEVEL) values (7, 7, 'Fifty Shades of Grey', 18, 2);
insert into BOOKS (ID, AUTHOR_ID, BOOK_NAME, RARS, ACCESS_LEVEL) values (8, 8, 'Радио не для всех. Закрытые частоты Минобороны.', 18, 1);
insert into BOOKS (ID, AUTHOR_ID, BOOK_NAME, RARS, ACCESS_LEVEL) values (9, 9, 'Оценка проходимости танка Армата в плотных слоях атмосферы', 18, 1);
...
insert into BOOK_GENRES (BOOK_ID, GENRE_ID) values (7, 2);
insert into BOOK_GENRES (BOOK_ID, GENRE_ID) values (8, 5);
insert into BOOK_GENRES (BOOK_ID, GENRE_ID) values (9, 5);
...
insert into COMMENTS (ID, BOOK_ID, POST_DATE, AUTHOR_NAME, CONTENT, FAVORITE) values ( 11,  6, '06.06.2019', 'Rafe Bennett', 'Not as good as the film', true);
insert into COMMENTS (ID, BOOK_ID, POST_DATE, AUTHOR_NAME, CONTENT, FAVORITE) values ( 12,  6, '12.08.2019', 'Mr A P Beattie', 'Excellent, engrossing the original 50 shades of grey', true);
